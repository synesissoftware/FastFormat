# Microsoft Developer Studio Project File - Name="test.unit.failure.mismatched.arguments" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.unit.failure.mismatched.arguments - Win32 Debug Multithreaded
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.unit.failure.mismatched.arguments.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.unit.failure.mismatched.arguments.mak" CFG="test.unit.failure.mismatched.arguments - Win32 Debug Multithreaded"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.unit.failure.mismatched.arguments - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.failure.mismatched.arguments - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.unit.failure.mismatched.arguments - Win32 Debug Multithreaded" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.unit.failure.mismatched.arguments - Win32 Release"
...
# ADD CPP /nologo /W3 /WX /GR /GX /O2 /I "$(XTESTS_C_ROOT)/include" /I "$(FASTFORMAT_ROOT)/include" /I "$(STLSOFT_PLUS)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "NDEBUG" /D "_AFXDLL" /D "_MBCS" /D "_CONSOLE" /YX /FD /c
...
# ADD LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /machine:I386 /out:"../../../../bin/test.unit.failure.mismatched.arguments.vc6.exe" /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(FASTFORMAT_ROOT)/lib"

!ELSEIF  "$(CFG)" == "test.unit.failure.mismatched.arguments - Win32 Debug"
...
# ADD CPP /nologo /W3 /WX /Gm /GR /GX /Zi /Od /I "$(XTESTS_C_ROOT)/include" /I "$(FASTFORMAT_ROOT)/include" /I "$(STLSOFT_PLUS)/include" /I "$(STLSOFT)/include" /D "WIN32" /D "_DEBUG" /D "_AFXDLL" /D "_MBCS" /D "_CONSOLE" /YX /FD /GZ /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.unit.failure.mismatched.arguments.vc6.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(FASTFORMAT_ROOT)/lib"

!ELSEIF  "$(CFG)" == "test.unit.failure.mismatched.arguments - Win32 Debug Multithreaded"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(FASTFORMAT_ROOT)/lib"
# ADD LINK32 kernel32.lib advapi32.lib ole32.lib oleaut32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../../../bin/test.unit.failure.mismatched.arguments.vc6.mt.debug.exe" /pdbtype:sept /libpath:"$(XTESTS_C_ROOT)/lib" /libpath:"$(FASTFORMAT_ROOT)/lib"

!ENDIF

# Begin Target

# Name "test.unit.failure.mismatched.arguments - Win32 Release"
# Name "test.unit.failure.mismatched.arguments - Win32 Debug"
# Name "test.unit.failure.mismatched.arguments - Win32 Debug Multithreaded"
...
SOURCE=..\test.unit.failure.mismatched.arguments.cpp
# End Source File
# End Group
